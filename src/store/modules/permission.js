...
const state = {
  ...
  btnPage: {
    ...
    PayStore: '/funds/pay/create',
    AgentStore: '/client/agent/create',
    AgentUpdate: '/client/agent/edit',
    AgentCheck: '/client/agent/review',
    ActivityStore: '/act/activity/create',
    ActivityUpdate: '/act/activity/edit',
    ActivityPatch: '/act/activity/review',
    ActivityComplaint: '/act/complaint',
    ActivityMessage: '/act/message',
    ActivityActuser: '/act/actuser',
    ActivityRed: '/act/red',
    ActivityPrestored: '/act/prestored',
    ActivityAppend: '/act/append',
    CardStore: '/act/card/create',
    CardUpdate: '/act/card/edit',
    CardLog: '/act/cardlog',
    CashStore: '/funds/cash/create',
    CashShow: '/funds/cash/detail',
    PaymentStore: '/funds/payment/create',
    AdExample: '/advertisement/example'
  },
  permissionBtnType: {
  }
}

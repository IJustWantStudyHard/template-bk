      ...
      <el-col>
        ...
        <el-card class="box-card">
          ...
          <el-form ref="person" :rules="rulesForm" :model="person" :label-position="$store.state.app.labelPosition" label-width="251px">
            ...
            <service v-else ref="serviceChild" :form="person" @change="updateForm" />
          </el-form>
...
export default {
  name: 'BaseInfo',
  components: { FileManager, Shop, Service },
  data() {
...
/deep/ .top-card .el-card__body {
  padding: 10px 20px;
  display: flex;
  justify-content: space-between;
  align-items: center;
}
/deep/ .person-avater .img-box img{
  border-radius: 50%;
}
</style>
